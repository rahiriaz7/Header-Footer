  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        ...
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-4"> MICROSOFT </h1>
      ...
      <Image className="lg:w-1/2 w-auto h-auto object-cover object-center rounded" 
      src="/img.WEBP" alt="" width={400} height={300}/>
    </div>
  </div>
</section>
    </div>
